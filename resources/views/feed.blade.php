...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/css-feed.css')}}">
        ...
        <div class="main-body p-0">
            <div class="inner-wrapper">
                ...
                <div class="inner-sidebar">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mr-2">
                                        ...
                                        <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                                            <div class="simplebar-content" style="padding: 16px;">
                                                <nav class="nav nav-pills nav-gap-y-1 flex-column">
                                                    <a href="javascript:void(0)" class="nav-link nav-link-faded has-icon active">Publicações</a>
                                                    <a href="{{url('amigos')}}" class="nav-link nav-link-faded has-icon">Amigos</a>
                                                    <a href="{{url('group')}}" class="nav-link nav-link-faded has-icon">Grupos</a>
                                                    <a href="{{url('msgpvd')}}" class="nav-link nav-link-faded has-icon">Mensagens privadas</a>
                                                    <a href="{{url('home')}}" class="nav-link nav-link-faded has-icon">Sair</a>
                                                </nav>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="inner-main">
                    ...
                    <option selected="">Ultimas</option>
                    <option value="1">Famosas</option>
                    <option value="3">Salvas</option>
                    <option value="3">Não salvas</option>
                    <option value="3">Não respondidas por você</option>
                </select>
                        <span class="input-icon input-icon-sm ml-auto w-auto">
                    <input type="text" class="form-control form-control-sm bg-gray-200 border-gray-200 shadow-none mb-4 mt-4" placeholder="Pesquisar algo..." />
                </span>
                    </div>
                    <!-- /Inner main header -->
                    ...
                    <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
                        <div class="card mb-2">
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="{{asset('assets/img/arthur.jpg')}}" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                                    <div class="media-body">
                                        <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">Arthur Porto @tucario#1234 </a></h6>
                                        <p class="text-secondary">
                                            Vale a pena estudar Ruby on rails?
                                        </p>
                                        <p class="text-muted"><a href="javascript:void(0)">Cleiton</a> Respondeu <span class="text-secondary font-weight-bold">13 minutos atrás</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                                        <span class="d-none d-sm-inline-block"><i class="far fa-eye"></i> 5</span>
                                        <span><i class="far fa-comment ml-2"></i> 15</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-2">
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="{{asset('assets/img/cleiton.jpg')}}" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                                    <div class="media-body">
                                        <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">Cleiton Pinheiro @lokpin#5588</a></h6>
                                        <p class="text-secondary">
                                            Trabalhar com onlyfans da muita dor de cabeça pqp
                                        </p>
                                        <p class="text-muted"><a href="javascript:void(0)">Arthur</a> Respondeu <span class="text-secondary font-weight-bold">2 horas atrás</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                                        <span class="d-none d-sm-inline-block"><i class="far fa-eye"></i> 4</span>
                                        <span><i class="far fa-comment ml-2"></i> 11</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-2">
                            <div class="card-body p-2 p-sm-3">
                                <div class="media forum-item">
                                    <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="{{asset('assets/img/rezende.jpg')}}" class="mr-3 rounded-circle" width="50" alt="User" /></a>
                                    <div class="media-body">
                                        <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">Lucas N Rezende @rezende#8798</a></h6>
                                        <p class="text-secondary">
                                            Finalmente sai daquele inferno, hora de ir para um emprego melhor. #PartiuReact 
                                        </p>
                                        <p class="text-muted"><a href="javascript:void(0)">Você</a> Respondeu <span class="text-secondary font-weight-bold">5 horas atrás</span></p>
                                    </div>
                                    <div class="text-muted small text-center align-self-center">
                                        <span class="d-none d-sm-inline-block"><i class="far fa-eye"></i> 22</span>
                                        <span><i class="far fa-comment ml-2"></i> 11</span>
                                    </div>
                                </div>
                            </div>
