    ...
    <h3 id="titulo-sistema">
        ...
        <div id="painel-login" class="panel panel-defaultt" style="margin: auto; width: 30%; background-color: #ff000000; margin-top: 11%;">
            <div class="panel-body" style="background-color: #ff000000; text-align: center;">
                ...
                <div>
                    <form action="{{route('logar')}}" method="post" style="max-width:300px;margin:auto; display: inline-grid;">
                    @csrf    
                    <div style="display: block">
                        ...
                        <div style="display: flex; margin-top: 10px;">
                            <input class="input-field" style="background: #e0e0e00d; border: solid 2px #363d4666; border-radius: 9px;" type="password" placeholder="Digite sua senha" name="senha">
                        </div>

                        <button class="button" type="submit" class="button teste">Entrar</button>
                        <a rel="stylesheet" style="color: #17243a; font-size: 15px; margin-top: 5px;" href="Cadastro.html">• Cadastrar-se</a>
                        <a rel="stylesheet" style="color: #17243a; font-size: 15px; margin-bottom: 15px; margin-top: 5px;" href="RecuperarSenha.html">• Esqueceu sua senha? Clique aqui</a>
                    </form>
                </div>
            </div>
